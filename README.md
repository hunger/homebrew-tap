...
|---------------|-----------------------|-----------------------|----------------------------------------------------|
| [`nvim-nightly`](https://github.com/neovim/neovim) | 0.13.0-dev-1708 | 2026-09-24T11:54:01Z | prebuilt `nightly` release, installed as `nvim-nightly`; coexists with `neovim` |
