...
|---------------|-----------------------|-----------------------|----------------------------------------------------|
| [`nvim-nightly`](https://github.com/neovim/neovim) | 0.13.0-dev-1721 | 2026-09-25T07:55:07Z | prebuilt `nightly` release, installed as `nvim-nightly`; coexists with `neovim` |
