...
|---------------|-----------------------|-----------------------|----------------------------------------------------|
| [`nvim-nightly`](https://github.com/neovim/neovim) | 0.13.0-dev-1681 | 2026-09-20T11:31:27Z | prebuilt `nightly` release, installed as `nvim-nightly`; coexists with `neovim` |
| [`kache`](https://github.com/kunobi-ninja/kache) | 0.26.0 | 2026-09-19T20:46:10Z | musl static binaries on Linux; shell completions |
