...
|---------------|-----------------------|-----------------------|----------------------------------------------------|
| [`nvim-nightly`](https://github.com/neovim/neovim) | 0.13.0-dev-1698 | 2026-09-23T07:49:09Z | prebuilt `nightly` release, installed as `nvim-nightly`; coexists with `neovim` |
